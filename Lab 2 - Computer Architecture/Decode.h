...
extern char* branch[Branch_Instruction]; // This is the array that is going to be used to store the names of the Branch instructions
...
extern void DISPLAY_Branch(void); // This function is going to be used to display the branch instructions
extern void DISPLAY_ARTH(); // This function is going to be used to display the Arthametic and logical instructions
extern void DISPLAY_BL(void); // This function is going to be used to display the Load instructions
